(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={error:{bg:`#fee2e2`,fg:`#991b1b`,border:`#fca5a5`,icon:`✕`},warning:{bg:`#fef3c7`,fg:`#92400e`,border:`#fde68a`,icon:`⚠`},success:{bg:`#d1fae5`,fg:`#065f46`,border:`#6ee7b7`,icon:`✓`},info:{bg:`#dbeafe`,fg:`#1e40af`,border:`#93c5fd`,icon:`ℹ`}},t=null;if(typeof HTMLElement<`u`){class n extends HTMLElement{_toasts=[];_nextId=0;connectedCallback(){t=this,this._renderShell()}disconnectedCallback(){t===this&&(t=null),this._toasts.forEach(e=>clearTimeout(e.timer)),this._toasts=[]}_renderShell(){if(this.querySelector(`.toast-container`))return;let e=document.createElement(`div`);e.className=`toast-container`,e.setAttribute(`role`,`status`),e.setAttribute(`aria-live`,`polite`),e.style.cssText=`position:fixed;top:1rem;right:1rem;z-index:10000;display:flex;flex-direction:column;gap:.5rem;pointer-events:none;max-width:360px;`,this.appendChild(e);let t=document.createElement(`div`);t.className=`loading-overlay`,t.style.cssText=`position:fixed;inset:0;z-index:9999;background:rgba(255,255,255,.65);display:none;align-items:center;justify-content:center;`,t.innerHTML=`<div style="display:flex;flex-direction:column;align-items:center;gap:.75rem;"><div class="spinner" style="width:32px;height:32px;border:3px solid #e5e7eb;border-top-color:#3b82f6;border-radius:50%;animation:es-toast-spin .6s linear infinite;"></div><span style="font-size:14px;color:#374151;">로딩 중…</span></div>`;let n=document.createElement(`style`);n.textContent=`@keyframes es-toast-spin{to{transform:rotate(360deg)}}`,this.appendChild(n),this.appendChild(t)}show(t,{type:n=`info`,duration:r=3e3,action:i}={}){let a=this.querySelector(`.toast-container`);if(!a)return;let o=e[n]||e.info,s=this._nextId++,c=document.createElement(`div`);c.className=`toast-item`,c.style.cssText=`pointer-events:auto;display:flex;align-items:flex-start;gap:.5rem;padding:.75rem 1rem;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,.12);font-size:14px;line-height:1.4;color:${o.fg};background:${o.bg};border:1px solid ${o.border};animation:es-toast-slide .2s ease-out;`;let l=document.createElement(`span`);l.style.cssText=`font-weight:700;font-size:16px;flex-shrink:0;`,l.textContent=o.icon,c.appendChild(l);let u=document.createElement(`span`);if(u.style.cssText=`flex:1;word-break:break-word;`,u.textContent=t,c.appendChild(u),i){let e=document.createElement(`button`);e.style.cssText=`background:none;border:none;color:${o.fg};text-decoration:underline;cursor:pointer;font-size:14px;padding:0;margin-left:.5rem;white-space:nowrap;`,e.textContent=i.label,e.addEventListener(`click`,()=>{i.onClick(),this._removeToast(s)}),c.appendChild(e)}let d=document.createElement(`button`);d.style.cssText=`background:none;border:none;font-size:16px;cursor:pointer;padding:0;margin-left:.25rem;color:inherit;opacity:.6;flex-shrink:0;`,d.textContent=`×`,d.setAttribute(`aria-label`,`닫기`),d.addEventListener(`click`,()=>this._removeToast(s)),c.appendChild(d),a.appendChild(c);let f=r>0?setTimeout(()=>this._removeToast(s),r):null;this._toasts.push({id:s,el:c,timer:f})}hideAll(){this._toasts.forEach(e=>{clearTimeout(e.timer),e.el.remove()}),this._toasts=[]}showLoading(){let e=this.querySelector(`.loading-overlay`);e&&(e.style.display=`flex`)}hideLoading(){let e=this.querySelector(`.loading-overlay`);e&&(e.style.display=`none`)}_removeToast(e){let t=this._toasts.findIndex(t=>t.id===e);if(t===-1)return;let[n]=this._toasts.splice(t,1);clearTimeout(n.timer),n.el.style.animation=`es-toast-slide .15s ease-in reverse`,setTimeout(()=>n.el.remove(),150)}}customElements.define(`es-toast`,n)}function n(){if(typeof document>`u`||typeof customElements>`u`||!customElements.get(`es-toast`)||!document.body)return null;let e=document.querySelector(`es-toast`);return e||(e=document.createElement(`es-toast`),document.body.appendChild(e)),e}function r(e,t){let r=n();r&&r.show(e,t)}var i=0;function a(){let e=n();e&&(i++,e.showLoading())}function o(){let e=t||(typeof document<`u`?document.querySelector(`es-toast`):null);e&&(i=Math.max(0,i-1),i===0&&e.hideLoading())}var s={score:{min:0,max:3,dotCount:4},grade:{excellent:83,good:58,average:33},motion:{totalMax:24,basic5Max:15},allowedGoalTags:[`💪 근력 향상`,`🔥 체지방 감소`,`🧘 자세 교정`,`🏃 체력 향상`,`⚖️ 체중 유지`,`🦵 하체 강화`,`🤸 유연성 개선`,`🩺 통증 개선`,`📈 근육량 증가`],vo2Norms:[{ageMin:18,ageMax:25,col:1,excellent:56,good:[47,56],above_avg:[42,46],average:[38,41],below_avg:[33,37],poor:[28,32],very_poor:28},{ageMin:26,ageMax:35,col:2,excellent:52,good:[45,52],above_avg:[39,44],average:[35,38],below_avg:[31,34],poor:[26,30],very_poor:26},{ageMin:36,ageMax:45,col:3,excellent:45,good:[38,45],above_avg:[34,37],average:[31,33],below_avg:[27,30],poor:[22,26],very_poor:22},{ageMin:46,ageMax:55,col:4,excellent:40,good:[34,40],above_avg:[31,33],average:[28,30],below_avg:[25,27],poor:[20,24],very_poor:20},{ageMin:56,ageMax:65,col:5,excellent:37,good:[32,37],above_avg:[28,31],average:[25,27],below_avg:[22,24],poor:[18,21],very_poor:18},{ageMin:66,ageMax:120,col:6,excellent:32,good:[28,32],above_avg:[25,27],average:[22,24],below_avg:[19,21],poor:[17,18],very_poor:17}]},c=s.score.min,l=s.score.max;s.score.dotCount;var u=s.grade.excellent,d=s.grade.good,f=s.grade.average,p=s.motion.totalMax;s.motion.basic5Max;var m=`checkday.auth.v1`,h=`checkday.refresh.v1`,g=`checkday:authchange`,_=class extends Error{constructor(e,t={}){super(e),this.name=`AppError`,this.code=t.code||`app_error`,this.status=t.status||0,t.cause&&(this.cause=t.cause)}};function v(e){return e instanceof _?e.message:e instanceof Error?e.message||`알 수 없는 오류가 발생했습니다`:String(e)}function y(){try{if(typeof window<`u`&&window.localStorage){let e=`__checkday_storage_test__`;return window.localStorage.setItem(e,`1`),window.localStorage.removeItem(e),window.localStorage}}catch{}if(typeof window<`u`&&window.sessionStorage)return window.sessionStorage;if(!globalThis.__checkdayTokenStore){let e=new Map;globalThis.__checkdayTokenStore={getItem:t=>e.has(t)?e.get(t):null,setItem:(t,n)=>e.set(t,String(n)),removeItem:t=>e.delete(t)}}return globalThis.__checkdayTokenStore}function b(){if(typeof window>`u`||!window.sessionStorage)return;let e=window.sessionStorage.getItem(m),t=window.sessionStorage.getItem(h);if(!e&&!t)return;let n=y();e&&!n.getItem(`checkday.auth.v1`)&&n.setItem(m,e),t&&!n.getItem(`checkday.refresh.v1`)&&n.setItem(h,t),window.sessionStorage.removeItem(m),window.sessionStorage.removeItem(h)}var x=!1;function S(){return x||(x=!0,b()),y().getItem(m)}function C(e){y().setItem(m,e)}function w(){return y().getItem(h)}function ee(e){y().setItem(h,e)}function T(){let e=y();e.removeItem(m),e.removeItem(h)}function E(){if(T(),!window.location.pathname.endsWith(`login.html`)){let e=encodeURIComponent(window.location.href);window.location.replace(`login.html?redirect=${e}`)}}var D=`https://checkday-rest-evztw4wu4q-du.a.run.app/api/v1`,O=class extends _{constructor(e,t,n){super(e,{code:t,status:n}),this.name=`ApiError`}};function k(e){let{"@namespaces":t,"@controls":n,"@embedded":r,"@error":i,"@meta":a,...o}=e;return r&&Object.assign(o,r),o}function A(e,t){C(e),ee(t),M()}function j(){T(),M()}function M(){typeof window>`u`||window.dispatchEvent(new CustomEvent(g))}function N(e){try{let t=e.split(`.`)[1].replace(/-/g,`+`).replace(/_/g,`/`);return JSON.parse(atob(t)).exp*1e3<Date.now()}catch{return!0}}var P=null;async function F(){if(P)return P;P=I();try{return await P}finally{P=null}}async function I(){let e=w();if(!e)return!1;try{let t=await fetch(`${D}/auth/refresh`,{method:`POST`,headers:{Accept:`application/json`,"Content-Type":`application/json`},body:JSON.stringify({refresh_token:e})});if(!t.ok)return!1;let n=k(await t.json());return n.access_token&&n.refresh_token?(A(n.access_token,n.refresh_token),!0):!1}catch{return!1}}async function L(e,t=null){let n=t;if(n===null)try{n=await e.json()}catch{n={}}let r=n[`@error`],i;return r?i=r[`@message`]:Array.isArray(n.detail)&&n.detail.length>0&&(i=n.detail.map(e=>e.msg).join(`; `)),new O(i||`요청을 처리할 수 없습니다`,r?.[`@code`]||`request_failed`,e.status)}async function R(e,{method:t=`GET`,body:n=null,token:r=null,as:i=`json`}={}){let a=`${D}${e}`,o={Accept:`application/json`},s=r??S();s&&(o.Authorization=`Bearer ${s}`),n!==null&&(o[`Content-Type`]=`application/json`);let c=()=>fetch(a,{method:t,headers:o,body:n===null?void 0:JSON.stringify(n)}),l=await c();if(l.status===401){if(!s)throw E(),new O(`인증이 필요합니다`,`unauthorized`,401);if(N(s)){if(await F()){if(o.Authorization=`Bearer ${S()}`,l=await c(),l.status===401)throw E(),new O(`갱신 후 인증이 거부되었습니다`,`refresh_retry_rejected`,401)}else throw E(),new O(`인증이 만료되었습니다`,`token_expired`,401)}else throw E(),new O(`인증이 거부되었습니다`,`token_rejected`,401)}if(i===`blob`){if(!l.ok)throw await L(l);return l.blob()}let u={};try{u=await l.json()}catch{u={}}if(!l.ok||u[`@error`])throw await L(l,u);let d=k(u);return d.items===void 0?d:d.items}async function z(e,t={}){try{return await R(e,t)}catch(e){throw e?.status!==401&&r(e.message||`요청을 처리할 수 없습니다`,{type:`error`}),e}}async function B(e,t={}){try{return await R(e,{...t,as:`blob`})}catch(e){throw e?.status!==401&&r(e.message||`요청을 처리할 수 없습니다`,{type:`error`}),e}}function V(){let e=S();return e?!N(e):!1}function H(e){window.addEventListener(`pageshow`,async t=>{if(t.persisted){if(!V()){E();return}if(e)try{await e()}catch(e){console.error(`bfcache 복원 후 화면 데이터 갱신 실패:`,e)}}})}async function U(e,t){let n=await z(`/auth/login`,{method:`POST`,body:{username:e,password:t}});return A(n.access_token,n.refresh_token),n}function W(){j()}var G=new Set;function K(e){return G.add(e),()=>G.delete(e)}function q(){G.forEach(e=>e())}typeof window<`u`&&(window.addEventListener(g,()=>q()),window.addEventListener(`storage`,e=>{(e.key===`checkday.auth.v1`||e.key===`checkday.refresh.v1`)&&q()}));function J(e){return String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}var Y=s.allowedGoalTags,X=`<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 10.5 12 3l9 7.5"/><path d="M5 9.8V21h14V9.8"/></svg>`,Z={scoreController({index:e,max:t,score:n=0}){return`<ui-score-controller class="score-ctrl-el" id="sc-${e}" score="${n}" max="${t}" min="0" dots="${t}" index="${e}" interactive show-value aria-label="항목 ${e+1} 점수"></ui-score-controller>`},assessmentCard({index:e,item:t,tags:n,extra:r=``}){return`
			...
			</div>`},feedbackCard({id:e,name:t,checkItems:n}){let r=n.map(e=>Z.fbCheckRow(e)).join(``);return`
			...
			<tr>
				...
				<tfoot>
					${a.map(e=>Z.compareTableRow(e)).join(``)}
				</tfoot>
			`;return`
			<table class="compare-table ${e.join(` `)}"${c}>
				...
				${u}
				<tbody>
					${i.map(e=>Z.compareTableRow(e)).join(``)}
				</tbody>
