import{t as e}from"./app-header-B5CSCFPt.js";import"./data-table-BRUfDUg7.js";var t=({variant:e,disabled:t,loading:n,type:r,ariaLabel:i})=>{let a=`btn btn-${e}${t?` disabled`:``}${n?` loading`:``}`,o={};i&&(o.label=i),t&&(o.disabled=`true`),n&&(o.busy=`true`);let s=``;for(let[e,t]of Object.entries(o))s+=` aria-${e}="${t}"`;return`
