import{_ as e,i as t,r as n,v as r}from"./app-header-BTjZ8e3c.js";/* empty css                     */import{i,o as a,s as o,t as s}from"./utils-dom-AA-aQdFf.js";import{n as c,r as l}from"./member-store-DgX5YVrk.js";import{c as u,d,l as f,t as p}from"./record-utils-D1crzlRW.js";import{n as m}from"./member-utils-C3eDrFg1.js";import{t as h}from"./utils-url-B0nUYPTI.js";import{n as g}from"./utils-array-Dlk6KB1T.js";import{i as _}from"./assessment-data-BzkGwTxd.js";import{r as v,t as y}from"./record-stats-rwahirZf.js";import{t as b}from"./inbody-smwfiy4b.js";import"./components-CVwuQHkn.js";t(k),f.subscribe(t=>t.loading?r():e());var x=Number(h(`docID`));function S(){return p(f.getState().records,x)}function C(e){let t=e.payload,r=m(l.getState().members,e.memberId),i=r?r.name:`회원`;a(`vh-title`,`<a class="vh-member" href="member-detail.html?memberID=${encodeURIComponent(e.memberId)}">${n(i)}</a>`);let o=[[`회차`,t.session||`-`],[`작성일`,e.date],[`담당 트레이너`,t.trainer||`-`],[`총점`,`${g(t.scores||[])} / ${v(e.payload)}`]];a(`vh-meta`,o.map(([e,t])=>`<span class="meta-item"><b>${e}</b>${n(t)}</span>`).join(``)),document.title=`${t.session||`체크기록`} — ${i} 조회`}function w(e){let t=e.payload.ib||{};a(`ib-grid`,y.map(({key:e,label:r})=>{let i=t[e]!=null&&t[e]!==``,a=i?t[e]:`―`,o=i?b(e,t[e]):``;return`
				<div class="ib-cell">
