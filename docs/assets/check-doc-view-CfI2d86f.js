import{i as e,n as t}from"./app-header-CObFATf5.js";/* empty css                     */import{i as n,o as r,s as i,t as a}from"./utils-dom-AA-aQdFf.js";import{n as o,r as s}from"./member-store-CP_dMBVY.js";import{c,d as l,l as u,t as d}from"./record-utils-T0atIRZs.js";import{n as f}from"./member-utils-C3eDrFg1.js";import{t as p}from"./utils-url-B0nUYPTI.js";import{n as m}from"./utils-array-Dlk6KB1T.js";import{i as h}from"./assessment-data-D8np2VSY.js";import{r as g,t as _}from"./record-stats-CKD6wDcP.js";import{t as v}from"./inbody-smwfiy4b.js";import"./components-BVE2fwiU.js";e(D);var y=Number(p(`docID`));function b(){return d(u.getState().records,y)}function x(e){let n=e.payload,i=f(s.getState().members,e.memberId),a=i?i.name:`회원`;r(`vh-title`,`<a class="vh-member" href="member-detail.html?memberID=${encodeURIComponent(e.memberId)}">${t(a)}</a>`);let o=[[`회차`,n.session||`-`],[`작성일`,e.date],[`담당 트레이너`,n.trainer||`-`],[`총점`,`${m(n.scores||[])} / ${g(e.payload)}`]];r(`vh-meta`,o.map(([e,n])=>`<span class="meta-item"><b>${e}</b>${t(n)}</span>`).join(``)),document.title=`${n.session||`체크기록`} — ${a} 조회`}function S(e){let n=e.payload.ib||{};r(`ib-grid`,_.map(({key:e,label:r})=>{let i=n[e]!=null&&n[e]!==``,a=i?n[e]:`―`,o=i?v(e,n[e]):``;return`
				<div class="ib-cell">
