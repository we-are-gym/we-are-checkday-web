import{i as e,r as t}from"./app-header-QCOnakgs.js";/* empty css                     */import{i as n,o as r,s as i,t as a}from"./utils-dom-y8yOKY5h.js";import{n as o,r as s}from"./member-store-BeCLUSmp.js";import{c,d as l,l as u,t as d}from"./record-utils-QV3OCxjZ.js";import{n as f}from"./member-utils-C3eDrFg1.js";import{n as p,t as m}from"./loading-overlay-BYL9g967.js";import{t as h}from"./utils-url-B0nUYPTI.js";import{n as g}from"./utils-array-Dlk6KB1T.js";import{i as _}from"./assessment-data-DjSUScYm.js";import{r as v,t as y}from"./record-stats-D9OcZbnV.js";import{t as b}from"./inbody-Br_ZMeNv.js";import"./components-DvITJp8A.js";e(k),u.subscribe(e=>e.loading?p():m());var x=Number(h(`docID`));function S(){return d(u.getState().records,x)}function C(e){let n=e.payload,i=f(s.getState().members,e.memberId),a=i?i.name:`회원`;r(`vh-title`,`<a class="vh-member" href="member-detail.html?memberID=${encodeURIComponent(e.memberId)}">${t(a)}</a>`);let o=[[`회차`,n.session||`-`],[`작성일`,e.date],[`담당 트레이너`,n.trainer||`-`],[`총점`,`${g(n.scores||[])} / ${v(e.payload)}`]];r(`vh-meta`,o.map(([e,n])=>`<span class="meta-item"><b>${e}</b>${t(n)}</span>`).join(``)),document.title=`${n.session||`체크기록`} — ${a} 조회`}function w(e){let n=e.payload.ib||{};r(`ib-grid`,y.map(({key:e,label:r})=>{let i=n[e]!=null&&n[e]!==``,a=i?n[e]:`―`,o=i?b(e,n[e]):``;return`
				<div class="ib-cell">
