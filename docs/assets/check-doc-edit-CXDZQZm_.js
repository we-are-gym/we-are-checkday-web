import{a as e,n as t,o as n}from"./app-header-CP8G8khd.js";/* empty css                     */import{i as r,n as i,r as a,t as o}from"./utils-dom-AA-aQdFf.js";import{n as s}from"./member-store-B2Qb6oPS.js";import{c,d as l,l as u,t as d,u as f}from"./record-utils-BSoo_L_t.js";import{t as p}from"./utils-url-B0nUYPTI.js";import{i as m,r as h}from"./assessment-data-D8np2VSY.js";import{c as g,f as _,m as v,p as y,r as b,s as x}from"./inbody-data-BJfCgwUH.js";import{n as S,r as C,t as w}from"./check-form-payload-CHlatitg.js";function T(t){let{tag:n,props:r={},render:i,connectedCallback:a,disconnectedCallback:o,attributeChangedCallback:s,observedAttributes:c=[]}=t;[...new Set([...c,...Object.keys(r)])];let l={render(){return i.call(this,l._getProps.call(this))},connectedCallback(){l._initProps.call(this),a&&a.call(this)},disconnectedCallback(){o&&o.call(this)},attributeChangedCallback(e,t,n){t!==n&&(r[e]!==void 0&&(this._props[e]=l._deserializeProp(e,n),l.refresh.call(this)),s&&s.call(this,e,t,n))},_initProps(){this._props={};for(let[e,t]of Object.entries(r)){let n=this.getAttribute(e);this._props[e]=n===null?t.default:l._deserializeProp(e,n)}},_deserializeProp(e,t){let n=r[e];return!n||n.type===String?t:n.type===Number?Number(t):n.type===Boolean?t!==`false`&&t!==``:n.type===Array?t?t.split(`,`).map(e=>e.trim()):[]:n.type===Object?t?JSON.parse(t):{}:t},_getProps(){return{...this._props}},setProp(e,t){this._props[e]!==t&&(this._props[e]=t,this.setAttribute(e,l._serializeProp(e,t)),l.refresh.call(this))},_serializeProp(e,t){let n=r[e];return!n||n.type===String?t:n.type===Number?String(t):n.type===Boolean?t?`true`:`false`:n.type===Array?t.join(`,`):n.type===Object?JSON.stringify(t):String(t)},emit(e,t={}){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))},refresh(){this.innerHTML=i.call(this,this._getProps())}};return e(n,l)}var E=({variant:e,disabled:t,loading:n,type:r,ariaLabel:i})=>{let a=`btn btn-${e}${t?` disabled`:``}${n?` loading`:``}`,o={};i&&(o.label=i),t&&(o.disabled=`true`),n&&(o.busy=`true`);let s=``;for(let[e,t]of Object.entries(o))s+=` aria-${e}="${t}"`;return`
			<button type="${r}" class="${a}"${s} ${t?`disabled`:``}>
				${n?`<span class="btn-spinner" aria-hidden="true"></span>`:``}
				<span class="btn-text"><slot>버튼</slot></span>
			</button>`};T({tag:`ui-button`,props:{variant:{type:String,default:`primary`},disabled:{type:Boolean,default:!1},loading:{type:Boolean,default:!1},type:{type:String,default:`button`},ariaLabel:{type:String,default:``}},render(){return E(this._getProps())},onConnect(){this.addEventListener(`click`,e=>{(this._props.disabled||this._props.loading)&&(e.preventDefault(),e.stopPropagation()),this.emit(`click`,{originalEvent:e})})}});var D=({href:e,variant:t,disabled:n,ariaLabel:r,target:i,rel:a})=>{let o=`btn btn-${t} link-btn${n?` disabled`:``}`,s={};r&&(s.label=r),n&&(s.disabled=`true`);let c=``;for(let[e,t]of Object.entries(s))c+=` aria-${e}="${t}"`;let l=i?` target="${i}"`:``,u=a?` rel="${a}"`:``;return`
			<a class="${o}"${n?``:` href="${e}"`}${l}${u}${c} role="button" tabindex="${n?-1:0}">
				<span class="btn-text"><slot>링크 버튼</slot></span>
			</a>`};T({tag:`ui-link-button`,props:{href:{type:String,default:`#`},variant:{type:String,default:`primary`},disabled:{type:Boolean,default:!1},ariaLabel:{type:String,default:``},target:{type:String,default:``},rel:{type:String,default:``}},render(){return D(this._getProps())},onConnect(){this.addEventListener(`click`,e=>{this._props.disabled&&(e.preventDefault(),e.stopPropagation()),this.emit(`click`,{originalEvent:e})}),this.addEventListener(`keydown`,e=>{this._props.disabled||(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),!this._props.disabled&&this._props.href&&this._props.href!==`#`&&(window.location.href=this._props.href))})}});var O=({header:e,subHeader:t,collapsible:n,expanded:r,footer:i,variant:a,ariaLabel:o,ariaDescribedBy:s},{elementId:c,hasFooterSlot:l})=>{let u=`card-${c||`auto`}`,d=e||t,f=i||l,p={};o&&(p.label=o),s&&(p.describedby=s),n&&(p.expanded=String(r));let m=``;for(let[e,t]of Object.entries(p))m+=` aria-${e}="${t}"`;return`
			...
			</div>`};T({tag:`ui-score-controller`,props:{score:{type:Number,default:0},max:{type:Number,default:3},min:{type:Number,default:0},dots:{type:Number,default:4},index:{type:Number,default:0},interactive:{type:Boolean,default:!0},ariaLabel:{type:String,default:``},ariaDescribedBy:{type:String,default:``},showValue:{type:Boolean,default:!0}},render(){return j(this._getProps())},onConnect(){this._props.interactive&&(this.addEventListener(`click`,e=>{let t=e.target.closest(`.score-btn`);if(!t)return;let n=Number(t.dataset.delta);this._adjustScore(n)}),this.addEventListener(`keydown`,e=>{this._props.interactive&&(e.key===`ArrowRight`||e.key===`ArrowUp`?(e.preventDefault(),this._adjustScore(1)):(e.key===`ArrowLeft`||e.key===`ArrowDown`)&&(e.preventDefault(),this._adjustScore(-1)))}))},_adjustScore(e){let{score:t,min:n,max:r}=this._props,i=Math.max(n,Math.min(r,t+e));i!==t&&(this.setProp(`score`,i),this.emit(`adjust`,{score:i,delta:e,index:this._props.index}))}});var M=({score:e,max:t,count:n,size:r,interactive:i,ariaLabel:a,ariaDescribedBy:o,prefix:s},{elementId:c})=>{let l=Math.max(0,Math.min(t,e)),u=`dots-${s||c||`auto`}`,d={};a&&(d.label=a),o&&(d.describedby=o),d.role=`group`,d[`aria-label`]=`점수 ${l}점 / ${t}점`;let f=``;for(let[e,t]of Object.entries(d))f+=` aria-${e}="${t}"`;return`
		...
		>
			...
			${t?`<span class="tag-remove" aria-hidden="true">×</span>`:``}
				...
				<div class="text-box-wrapper${s?` disabled`:``}${c?` readonly`:``}${_?` has-error`:``}">
					...
					${_?`<div class="text-box-error" id="${S}" role="alert">${_}</div>`:``}
					${a>0?`<div class="text-box-counter" aria-hidden="true"><span class="current">${e.length}</span> / ${a}</div>`:``}
				</div>`};T({tag:`ui-text-box`,props:{value:{type:String,default:``},placeholder:{type:String,default:``},multiline:{type:Boolean,default:!1},rows:{type:Number,default:4},cols:{type:Number,default:50},maxLength:{type:Number,default:0},minLength:{type:Number,default:0},disabled:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},required:{type:Boolean,default:!1},spellcheck:{type:Boolean,default:!1},autocomplete:{type:String,default:`off`},ariaLabel:{type:String,default:``},ariaDescribedBy:{type:String,default:``},ariaInvalid:{type:Boolean,default:!1},label:{type:String,default:``},hint:{type:String,default:``},error:{type:String,default:``},autoResize:{type:Boolean,default:!1}},render(){return I(this._getProps(),{elementId:this.id})},onConnect(){let e=this.querySelector(`.text-box`);if(e){if(e.addEventListener(`input`,e=>{this.setProp(`value`,e.target.value),this.emit(`input`,{value:this._props.value,originalEvent:e})}),e.addEventListener(`change`,e=>{this.emit(`change`,{value:this._props.value,originalEvent:e})}),e.addEventListener(`blur`,e=>{this.emit(`blur`,{value:this._props.value,originalEvent:e})}),e.addEventListener(`focus`,e=>{this.emit(`focus`,{value:this._props.value,originalEvent:e})}),this._props.multiline&&this._props.autoResize){let t=()=>{e.style.height=`auto`,e.style.height=`${e.scrollHeight}px`};e.addEventListener(`input`,t),setTimeout(t,0)}if(this._props.maxLength>0){let t=this.querySelector(`.text-box-counter .current`);t&&e.addEventListener(`input`,()=>{t.textContent=this._props.value.length})}}}}),n();var L=Number(p(`docID`));function R(){return d(u.getState().records,L)}async function z(){try{let e=o(`m-date`),t=R();if(!t){alert(`편집 대상 기록을 찾을 수 없습니다.`);return}let n=e&&e.value||t.date;await f(L,w(),{memberId:t.memberId,date:n}),window.location.href=`check-doc-view.html?docID=${L}`}catch(e){console.error(`체크기록 수정 실패:`,e)}}function B(){confirm(`편집 내용을 저장 전 상태로 되돌릴까요?`)&&C(R())}async function V(){try{await s();let e=await l(L);u.setState(t=>({...t,records:[...t.records.filter(e=>e.id!==L),c(e)]}))}catch(e){console.error(`기록 로드 실패:`,e),o(`eval-cards`).innerHTML=`<p class="goal-empty">기록을 불러오지 못했습니다.</p>`,o(`fb-cards`).style.display=`none`,o(`btn-cancel`).href=`members.html`,r(`[data-action]`).forEach(e=>e.style.display=`none`);return}let e=R();if(!e){o(`eval-cards`).innerHTML=`<p class="goal-empty">기록을 찾을 수 없습니다. 목록에서 다시 선택하세요.</p>`,o(`fb-cards`).style.display=`none`,o(`btn-cancel`).href=`members.html`,r(`[data-action]`).forEach(e=>e.style.display=`none`);return}let t=`check-doc-view.html?docID=${L}`;o(`btn-cancel`).href=t;let n=m(e.payload);x({items:n,max:n.length*3}),_(),U(),C(e),o(`eval-sec-sub`).textContent=`${n.length}개 항목 · 각 0–3점`}function H(e,t){let n=g().map((e,t)=>v.get(t)),r=g().map((e,t)=>{let n=o(`sp-${t}`);return{checked:[...n.querySelectorAll(`.ctag.on`)].map(e=>e.textContent),memo:(n.querySelector(`.eval-memo`)||{}).value||``}});t!==void 0&&(n.splice(t,1),r.splice(t,1)),x({items:e,max:e.length*3}),o(`eval-cards`).innerHTML=``,_(),U(),S(n,r),y()}function U(){r(`.eval-card`).forEach((e,t)=>{let n=e.querySelector(`.eval-title`);if(!n||n.querySelector(`.eval-remove`))return;let r=document.createElement(`button`);r.type=`button`,r.className=`eval-remove`,r.dataset.evalRemove=String(t),r.textContent=`×`,r.title=`항목 삭제`,n.appendChild(r)})}function W(){let e=new Set(m(R().payload).map(e=>e.name));return h.filter(t=>!e.has(t.name))}function G(){let e=W();if(e.length===0){alert(`추가할 수 있는 평가 항목이 없습니다.`);return}let n=o(`eval-picker-overlay`),r=o(`eval-picker-list`);r.innerHTML=e.map((e,n)=>`<button type="button" class="picker-item" data-picker-item="${n}">${t(e.name)}</button>`).join(``),n.classList.add(`open`)}function K(e){let t=m(R().payload);if(t.length<=1){alert(`최소 1개의 평가 항목은 남겨야 합니다.`);return}let n=t.slice();n.splice(e,1),H(n,e)}b(),i(document,`click`,`[data-action]`,(e,t)=>{switch(t.dataset.action){case`reset`:B();break;case`save`:z();break;case`close-picker`:o(`eval-picker-overlay`).classList.remove(`open`)}}),o(`add-eval-btn`).addEventListener(`click`,G),i(document,`click`,`[data-eval-remove]`,(e,t)=>K(Number(t.dataset.evalRemove))),i(document,`click`,`[data-picker-item]`,(e,t)=>{let n=Number(t.dataset.pickerItem),r=W()[n];r&&(H([...m(R().payload),r]),o(`eval-picker-overlay`).classList.remove(`open`))}),a(`eval-picker-overlay`),V();