(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`checkday.auth.v1`,t=`checkday.refresh.v1`,n=`checkday:authchange`;function r(){if(sessionStorage.removeItem(e),sessionStorage.removeItem(t),!window.location.pathname.endsWith(`login.html`)){let e=encodeURIComponent(window.location.href);window.location.replace(`login.html?redirect=${e}`)}}var i=`https://checkday-rest-evztw4wu4q-du.a.run.app/api/v1`;console.log({API_BASE:i});var a=class extends Error{constructor(e,t,n){super(e),this.name=`ApiError`,this.code=t,this.status=n}};function o(e){let{"@namespaces":t,"@controls":n,"@embedded":r,"@error":i,"@meta":a,...o}=e;return r&&Object.assign(o,r),o}function s(n,r){sessionStorage.setItem(e,n),sessionStorage.setItem(t,r),l()}function c(){sessionStorage.removeItem(e),sessionStorage.removeItem(t),l()}function l(){typeof window>`u`||window.dispatchEvent(new CustomEvent(n))}function u(e){try{let t=e.split(`.`)[1].replace(/-/g,`+`).replace(/_/g,`/`);return JSON.parse(atob(t)).exp*1e3<Date.now()}catch{return!0}}var d=null;async function f(){if(d)return d;d=p();try{return await d}finally{d=null}}async function p(){let e=sessionStorage.getItem(t);if(!e)return!1;try{let t=await fetch(`${i}/auth/refresh`,{method:`POST`,headers:{Accept:`application/json`,"Content-Type":`application/json`},body:JSON.stringify({refresh_token:e})});if(!t.ok)return!1;let n=o(await t.json());return n.access_token&&n.refresh_token?(s(n.access_token,n.refresh_token),!0):!1}catch{return!1}}async function m(e,t=null){let n=t;if(n===null)try{n=await e.json()}catch{n={}}let r=n[`@error`],i;return r?i=r[`@message`]:Array.isArray(n.detail)&&n.detail.length>0&&(i=n.detail.map(e=>e.msg).join(`; `)),new a(i||`요청을 처리할 수 없습니다`,r?.[`@code`]||`request_failed`,e.status)}async function h(t,{method:n=`GET`,body:s=null,token:c=null,as:l=`json`}={}){let d=`${i}${t}`,p={Accept:`application/json`},h=c??sessionStorage.getItem(`checkday.auth.v1`);h&&(p.Authorization=`Bearer ${h}`),s!==null&&(p[`Content-Type`]=`application/json`);let g=()=>fetch(d,{method:n,headers:p,body:s===null?void 0:JSON.stringify(s)}),_=await g();if(_.status===401){if(!h)throw r(),new a(`인증이 필요합니다`,`unauthorized`,401);if(u(h)){if(await f()){if(p.Authorization=`Bearer ${sessionStorage.getItem(e)}`,_=await g(),_.status===401)throw r(),new a(`갱신 후 인증이 거부되었습니다`,`refresh_retry_rejected`,401)}else throw r(),new a(`인증이 만료되었습니다`,`token_expired`,401)}else throw r(),new a(`인증이 거부되었습니다`,`token_rejected`,401)}if(l===`blob`){if(!_.ok)throw await m(_);return _.blob()}let v={};try{v=await _.json()}catch{v={}}if(!_.ok||v[`@error`])throw await m(_,v);let y=o(v);return y.items===void 0?y:y.items}async function g(e,t={}){return h(e,t)}async function _(e,t={}){return h(e,{...t,as:`blob`})}function v(){let t=sessionStorage.getItem(e);return t?!u(t):!1}function y(e){window.addEventListener(`pageshow`,async t=>{if(t.persisted){if(!v()){r();return}if(e)try{await e()}catch(e){console.error(`bfcache 복원 후 화면 데이터 갱신 실패:`,e)}}})}async function b(e,t){let n=await g(`/auth/login`,{method:`POST`,body:{username:e,password:t}});return s(n.access_token,n.refresh_token),n}function x(){c()}var S=new Set;function C(e){return S.add(e),()=>S.delete(e)}function w(){S.forEach(e=>e())}typeof window<`u`&&(window.addEventListener(n,()=>w()),window.addEventListener(`storage`,e=>{(e.key===`checkday.auth.v1`||e.key===`checkday.refresh.v1`)&&w()}));function T(e,t){class n extends HTMLElement{connectedCallback(){t.connectedCallback&&t.connectedCallback.call(this),this.refresh(),t.onConnect&&t.onConnect.call(this)}refresh(){this.innerHTML=t.render.call(this),t.refreshAfter&&t.refreshAfter.call(this)}}for(let e of Object.keys(t))e!==`render`&&e!==`onConnect`&&e!==`refreshAfter`&&e!==`connectedCallback`&&typeof t[e]==`function`&&(n.prototype[e]=t[e]);return customElements.define(e,n),n}function E(e){return String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#39;`)}var D=[`💪 근력 향상`,`🔥 체지방 감소`,`🧘 자세 교정`,`🏃 체력 향상`,`⚖️ 체중 유지`,`🦵 하체 강화`,`🤸 유연성 개선`,`🩺 통증 개선`,`📈 근육량 증가`],O=`<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 10.5 12 3l9 7.5"/><path d="M5 9.8V21h14V9.8"/></svg>`,k={scoreController({index:e,max:t,score:n=0}){return`<ui-score-controller class="score-ctrl-el" id="sc-${e}" score="${n}" max="${t}" min="0" dots="${t}" index="${e}" interactive show-value aria-label="항목 ${e+1} 점수"></ui-score-controller>`},assessmentCard({index:e,item:t,tags:n,extra:r=``}){return`
			<div class="eval-item">
				<div class="eval-top">
