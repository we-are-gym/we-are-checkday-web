...
import { ASSESSMENT_ITEMS_BASIC5, ASSESSMENT_ITEMS_FULL } from "./assessment-data.js";
...
const SEED_RECORDS = [
	...
	mk5(1, 1, "2026-01-10", "1회차", ib("80.1", "31.8", "23.9", "25.9", "29.8", "1740", "11"),
		[2, 1, 1, 2, 1], {
			name: "김민준",
			trainer: "김지훈",
	...
	mk5(2, 1, "2026-02-14", "2회차", ib("79.0", "32.0", "22.1", "25.5", "28.0", "1728", "10"),
		[2, 2, 1, 2, 2], {
			name: "김민준",
			trainer: "김지훈",
	...
	mk5(3, 1, "2026-03-21", "3회차", ib("79.6", "31.6", "23.4", "25.7", "29.4", "1719", "11"),
		[2, 2, 2, 2, 2], {
			name: "김민준",
			trainer: "김지훈",
	...
	mk5(4, 1, "2026-04-12", "4회차", ib("76.4", "32.8", "18.9", "24.7", "24.7", "1701", "9"),
		[2, 2, 2, 2, 3], {
			name: "김민준",
			trainer: "김지훈",
	...
	mk5(5, 1, "2026-07-11", "5회차", ib("75.2", "33.2", "17.4", "24.3", "23.1", "1689", "8"),
		[3, 2, 2, 2, 3], {
			name: "김민준",
			trainer: "김지훈",
	...
	mk5(6, 2, "2026-02-08", "1회차", ib("57.0", "23.6", "20.3", "21.4", "35.6", "1318", "6"),
		[2, 2, 1, 2, 2], {
			name: "이서연",
			trainer: "박소연",
			ibComment: "첫 측정 — 골격근량 대비 체지방률 높은 편, 근력 운동 우선",
			goals: ["체지방률 32% 이하"],
			goalMemo: "하체 중심 2분할 루틴",
			consultMemo: "런지 시 무릎 통증 호소 — 무릎 정렬 체크 반복",
		}),
	mk5(7, 2, "2026-04-12", "2회차", ib("57.3", "23.4", "19.6", "21.5", "34.2", "1324", "7"),
		[2, 3, 2, 2, 2], {
			name: "이서연",
			trainer: "박소연",
			ibComment: "체지방률 하락, 골격근량은 소폭 감소 — 운동 강도 유지 필요",
	...
	mk5(9, 2, "2026-06-20", "3회차", ib("56.4", "24.1", "19.8", "21.2", "35.1", "1310", "5"),
		[2, 3, 2, 2, 3], {
			name: "이서연",
			trainer: "박소연",
			ibComment: "골격근량 회복(+0.7kg), 체지방률은 1회차 수준으로 재상승",
			goals: ["체지방률 32% 이하"],
			goalMemo: "유산소 30분 + 근력 2분할 유지",
			consultMemo: "주말 외식 빈도 조절 상담",
		}),
	// 최수아(4) — 4건: 05-16(2회차)만 8항목/24점, 그 외 5항목/15점 (기록별 만점 차이 데모)
	mk5(10, 4, "2026-02-15", "1회차", ib("63.5", "24.9", "24.2", "23.8", "38.1", "1380", "6"),
		[1, 2, 1, 2, 2], {
			name: "최수아",
			trainer: "김지훈",
	...
	mkRec(8, 4, "2026-05-16", "2회차", ib("62.1", "25.6", "21.6", "23.3", "34.8", "1402", "5"),
		[2, 2, 2, 2, 2, 2, 2, 2], {
			name: "최수아",
			trainer: "김지훈",
			ibComment: "체지방 감소·근량 유지 — 순조로운 진행 (8항목 전체 측정)",
			goals: ["체형 교정"],
			goalMemo: "스트레칭 10분 일상화",
			consultMemo: "데드리프트 자세 안정화됨",
		}),
	mk5(11, 4, "2026-07-20", "3회차", ib("62.8", "25.2", "22.4", "23.6", "35.7", "1394", "6"),
		[2, 3, 2, 2, 3], {
			name: "최수아",
			trainer: "김지훈",
	...
	mk5(12, 4, "2026-08-15", "4회차", ib("59.8", "26.6", "17.9", "22.4", "30.0", "1440", "4"),
		[3, 2, 2, 3, 3], {
			name: "최수아",
			trainer: "김지훈",
	...
	mk5(13, 5, "2026-03-14", "1회차", ib("72.0", "27.5", "19.1", "23.9", "26.5", "1495", "7"),
		[1, 2, 1, 2, 1], {
			name: "정우진",
			trainer: "박소연",
	...
	mk5(14, 5, "2026-05-20", "2회차", ib("72.8", "27.1", "19.7", "24.2", "27.1", "1502", "8"),
		[2, 2, 2, 1, 2], {
			name: "정우진",
			trainer: "박소연",
			ibComment: "체지방률·내장지방 상승 — 야식 패턴 확인, 식단 점검 필요",
	...
	mk5(16, 5, "2026-07-05", "3회차", ib("71.9", "28.0", "18.7", "23.9", "26.0", "1515", "7"),
		[2, 3, 2, 2, 2], {
			name: "정우진",
			trainer: "박소연",
	...
	mk5(17, 6, "2026-01-10", "1회차", ib("61.5", "26.1", "19.4", "23.4", "31.5", "1308", "6"),
		[2, 2, 1, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
			ibComment: "첫 측정 — 기준값 확보",
	...
	mk5(18, 6, "2026-02-12", "2회차", ib("62.4", "26.6", "19.2", "23.8", "30.8", "1322", "5"),
		[2, 3, 2, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mk5(19, 6, "2026-03-08", "3회차", ib("61.2", "26.0", "19.6", "23.3", "32.1", "1301", "6"),
		[2, 2, 2, 2, 3], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mk5(21, 6, "2026-04-15", "4회차", ib("63.0", "26.9", "19.0", "24.0", "30.2", "1335", "5"),
		[3, 2, 2, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mk5(22, 6, "2026-06-14", "6회차", ib("62.6", "26.7", "19.2", "23.9", "30.7", "1328", "5"),
		[3, 2, 3, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mk5(23, 6, "2026-07-11", "7회차", ib("61.0", "26.2", "19.8", "23.2", "32.4", "1298", "7"),
		[2, 2, 2, 3, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mk5(24, 6, "2026-08-10", "8회차", ib("62.2", "26.6", "19.0", "23.7", "30.5", "1325", "5"),
		[3, 3, 2, 2, 3], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mk5(25, 7, "2026-03-08", "1회차", ib("68.5", "30.2", "14.8", "22.9", "21.6", "1580", "5"),
		[1, 1, 2, 1, 1], {
			name: "김도윤",
			trainer: "김지훈",
			ibComment: "첫 측정 — 기준값 확보, 골격근량 증량 목표",
	...
	mkRec(20, 7, "2026-05-17", "2회차", ib("70.1", "31.5", "15.2", "23.4", "21.7", "1615", "6"),
		[2, 2, 1, 2, 1, 2, 1, 2], {
			name: "김도윤",
			trainer: "김지훈",
			ibComment: "골격근량 +1.3kg, 체지방률 유지 — 증량 방향 양호 (8항목 전체 측정)",
			goals: ["골격근량 33kg"],
			goalMemo: "상체 저중량 고반복 + 하체 중강도",
			feedbacks: [{ name: "스쿼트", checkItems: [{ text: "발목 가동성 부족", checked: true }], memo: "발목 스트레칭 루틴 추가" }],
			consultMemo: "단백질 섭취 타이밍 상담",
		}),
	mk5(26, 7, "2026-07-26", "3회차", ib("69.9", "31.4", "15.0", "23.4", "21.5", "1608", "5"),
		[2, 2, 2, 2, 2], {
			name: "김도윤",
			trainer: "김지훈",
