...
const SEED_RECORDS = [
	...
	mkRec(7, 6, "2026-01-10", "2026-01 (1회차)", ib("61.5", "26.1", "19.4", "23.4", "31.5", "1308", "6"),
		[2, 2, 2, 1, 2, 2, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
			ibComment: "첫 측정 — 기준값 확보",
	...
	mkRec(8, 6, "2026-02-12", "2026-02 (2회차)", ib("62.4", "26.6", "19.2", "23.8", "30.8", "1322", "5"),
		[2, 3, 2, 2, 2, 2, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mkRec(9, 6, "2026-03-08", "2026-03 (3회차)", ib("61.2", "26.0", "19.6", "23.3", "32.1", "1301", "6"),
		[2, 2, 2, 2, 3, 2, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mkRec(10, 6, "2026-04-15", "2026-04 (4회차)", ib("63.0", "26.9", "19.0", "24.0", "30.2", "1335", "5"),
		[3, 2, 2, 2, 2, 2, 2, 3], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mkRec(11, 6, "2026-05-09", "2026-05 (5회차)", ib("61.8", "26.3", "19.7", "23.6", "31.9", "1314", "6"),
		[2, 3, 2, 2, 2, 3, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mkRec(12, 6, "2026-06-14", "2026-06 (6회차)", ib("62.6", "26.7", "19.2", "23.9", "30.7", "1328", "5"),
		[3, 2, 3, 2, 2, 2, 2, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mkRec(13, 6, "2026-07-11", "2026-07 (7회차)", ib("61.0", "26.2", "19.8", "23.2", "32.4", "1298", "7"),
		[2, 2, 2, 3, 2, 2, 3, 2], {
			name: "김하늘",
			trainer: "김지훈",
	...
	mkRec(14, 6, "2026-08-10", "2026-08 (8회차)", ib("62.2", "26.6", "19.0", "23.7", "30.5", "1325", "5"),
		[3, 3, 2, 2, 3, 2, 3, 3], {
			name: "김하늘",
			trainer: "김지훈",
